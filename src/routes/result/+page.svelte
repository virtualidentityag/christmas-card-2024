		...
		<div class="max-w-lg">
			<div class="flex divide-x-[3px] divide-[#1C2E4F] mb-16">
				<p class="text-lg leading-none pe-14">
					<span class="font-bold text-9xl text-[#E5433E]">{collectedItems}</span><br>
					collected <br> ornaments.
				</p>
				<p class="text-lg ps-14 leading-none">
					<span class="font-bold text-9xl text-[#2697E2]">{score}
			...
			<p class="text-lg leading-relaxed font-bold">We wish you and your loved ones a wonderful Christmas and a  Happy New Year!</p>
